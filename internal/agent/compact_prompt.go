...
const preFlushPrompt = `You are about to lose access to older parts of this conversation due to context window limits. Before that happens, please review the conversation history and persist any important information you want to remember:
...
const flushSkipSentinel = "FLUSH_SKIP"
